...
function formingDashboardScreenshot() {
    let [account, selected_id, balance, prev_total_profit, dates, trades, percentages, profits] = getInputData("dashboard");
    ...
    switch(account) {
        case "bill":
            image_url = "url(/images/bot/dashboard-bill.png)";
            break;
        case "phil":
            image_url = "url(/images/bot/dashboard-phil.png)";
            break;
        case "alex":
            image_url = "url(/images/bot/dashboard-alex.png)";
            break;
    }
...
function formingSettingsScreenshot() {
    ...
    switch(account) {
        case "bill":
            image_url = "url(/images/bot/settings-bill.png)";
            break;
        case "phil":
            image_url = "url(/images/bot/settings-phil.png)";
            break;
        case "alex":
            image_url = "url(/images/bot/settings-alex.png)";
            break;
    }
    document.getElementById('screenshot').style.backgroundImage = image_url;
}
...
function getInputData(section) {
    ...
    switch(section) {
        case "dashboard":
            ...
            return [account, selected_id_dashboard, balance, prev_total_profit, dates, trades, percentages, profits];
